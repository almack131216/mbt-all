...
$sections[] = array(
	'icon'       => 'el-icon-magic',
	'icon_class' => 'icon-large',
	'title'      => __( 'Modules and Speed', 'kleo_framework' ),
	'customizer' => false,
	...
	'fields'     => array(
		...
		array(
			'id'          => 'performance',
			'type'        => 'switch',
			'title'       => __( 'PERFORMANCE and SPEED', 'kleo_framework' ),
			'subtitle'    => __( 'Enable theme modules system.', 'kleo_framework' ),
			'description' => 'When enabled, we will generate the main app.css and plugins.css files to include only the modules and shortcodes enabled below. <br><i>Note: Make sure you have write permissions on your server under wp-content/uploads</i>',
			'default'     => '0' // 1 = checked | 0 = unchecked
		),
		array(
			'id'          => 'perf_combine_css',
			'type'        => 'switch',
			'title'       => __( 'Combine theme CSS files', 'kleo_framework' ),
			'subtitle'    => __( 'Combine all theme CSS files into one single file', 'kleo_framework' ),
			'description' => 'It will combine bootstrap.css, magnific-popup.css, app.css and plugins.css ',
			'default'     => '0' // 1 = checked | 0 = unchecked
		),
		array(
			'id'          => 'perf_combine_js',
			'type'        => 'switch',
			'title'       => __( 'Combine theme JS files', 'kleo_framework' ),
			'subtitle'    => __( 'Combine all theme JS files into one single file', 'kleo_framework' ),
			'description' => 'It will combine bootstrap.js, waypoints.js, magnific-popup.js, caroufredsel.js, jquery.touchSwipe.min.js and jquery.isotope.min.js',
			'default'     => '0' // 1 = checked | 0 = unchecked
		),
		array(
			'id'          => 'perf_remove_query',
			'type'        => 'switch',
			'title'       => __( 'Remove query string', 'kleo_framework' ),
			'subtitle'    => __( 'Remove the ?v=4.1 query strings from theme css and js loaded files', 'kleo_framework' ),
			'description' => 'This is sometimes required if you want to increase your Google page speed scores and for better file caching.',
			'default'     => '0' // 1 = checked | 0 = unchecked
		),
		array(
			'id'       => 'section-title-modules',
			'type'     => 'section',
			'title'    => __( 'MODULES settings', 'kleo_framework' ),
			'subtitle' => __( "Choose what modules to enable", 'kleo_framework' ),
		...
		array(
			...
			'type'     => 'section',
			'title'    => __( 'Shortcode settings', 'kleo_framework' ),
			'subtitle' => __( "Choose what shortcodes to enable", 'kleo_framework' ),
			'indent'   => false, // Indent all options below until the next 'section' option is set.
		),
		array(
			'id'       => 'sh_feature_item',
			'type'     => 'switch',
			'title'    => __( 'Feature Items shortcode', 'kleo_framework' ),
			'subtitle' => sprintf( __( 'Enable if you use [kleo_grid] and [kleo_feature_item] shortcodes.<br>See <a href="%s" target="_blank">shortcode demo</a>.', 'kleo_framework' ), 'http://seventhqueen.com/themes/kleo/feature-items/' ),
			'default'  => '1' // 1 = checked | 0 = unchecked
		),
		array(
			'id'       => 'sh_kleo_register',
			'type'     => 'switch',
			'title'    => __( 'Kleo_register shortcode', 'kleo_framework' ),
			'subtitle' => sprintf( __( 'Enable if you use [kleo_register] shortcode.<br>See <a href="%s" target="_blank">shortcode demo</a>.', 'kleo_framework' ), 'http://seventhqueen.com/themes/kleo/home-register/' ),
			'default'  => '1' // 1 = checked | 0 = unchecked
		),
		array(
			'id'       => 'sh_news_focus',
			'type'     => 'switch',
			'title'    => __( 'News Focus shortcode', 'kleo_framework' ),
			'subtitle' => __( 'Enable if you use [kleo_news_focus] shortcode', 'kleo_framework' ),
			'default'  => '1' // 1 = checked | 0 = unchecked
		),
		array(
			'id'       => 'sh_news_highlight',
			'type'     => 'switch',
			'title'    => __( 'News Highlight shortcode', 'kleo_framework' ),
			'subtitle' => __( 'Enable if you use [kleo_news_highlight] shortcode', 'kleo_framework' ),
			'default'  => '1' // 1 = checked | 0 = unchecked
		),
		array(
			'id'       => 'sh_news_ticker',
		...
		array(
			'id'       => 'sh_poi',
			'type'     => 'switch',
			'title'    => __( 'Poi/Pin shortcode', 'kleo_framework' ),
			'subtitle' => __( 'Enable if you use [kleo_pin] shortcode', 'kleo_framework' ),
			'default'  => '1' // 1 = checked | 0 = unchecked
		),
		array(
			'id'       => 'sh_pricing_table',
			'type'     => 'switch',
			'title'    => __( 'Pricing table shortcode', 'kleo_framework' ),
			'subtitle' => __( 'Enable if you use [kleo_pricing_table] shortcode', 'kleo_framework' ),
			'default'  => '1' // 1 = checked | 0 = unchecked
		),
		array(
	...
	'fields'     => array(
		array(
			...
			'options'  => array(
				'normal'      => array(
					'alt' => 'Normal header',
					'img' => KLEO_FW_URI . '/assets/img/header_normal.png'
				),
				'extras'      => array(
					'alt' => 'Extras header',
					'img' => KLEO_FW_URI . '/assets/img/header_extras.png'
				),
				'split'       => array(
					'alt' => 'Split header',
					'img' => KLEO_FW_URI . '/assets/img/header_split.png'
				),
				'lp'          => array( 'alt' => 'LP header', 'img' => KLEO_FW_URI . '/assets/img/header_lp.png' ),
				'right_logo'  => array(
					'alt' => 'Right logo',
					'img' => KLEO_FW_URI . '/assets/img/header_logo_to_right.png'
				),
				'center_logo' => array(
					'alt' => 'Center logo',
					'img' => KLEO_FW_URI . '/assets/img/header_centered.png'
				),
				'left_logo'   => array(
					'alt' => 'Left logo and menu',
					'img' => KLEO_FW_URI . '/assets/img/header_left.png'
				),
			),
			'default'  => 'normal'
		),
		...
		array(
			'id'          => 'menu_height',
			'type'        => 'text',
			'title'       => __( 'Header Height', 'kleo_framework' ),
			'description' => __( 'Set your header height(expressed in pixels). Example: 88', 'kleo_framework' ),
			'subtitle'    => __( 'Applies the height to the logo container', 'kleo_framework' ),
			'default'     => '88'
		),
		array(
			'id'          => 'menu_two_height',
			...
			'title'       => __( 'Menu Height', 'kleo_framework' ),
			'subtitle'    => __( 'Applies only to Left and Centered header layout', 'kleo_framework' ),
			'description' => __( 'Set your menu height(expressed in pixels). Example: 88', 'kleo_framework' ),
			'default'     => '88'
		),
		array(
			'id'       => 'sticky_menu',
		...
		array(
			...
			'title'       => __( 'Header Height when scrolled', 'kleo_framework' ),
			'subtitle'    => __( 'Set your header height(expressed in pixels). Default is half the Header height', 'kleo_framework' ),
			'description' => __( 'Applies when the header is scrolled(expressed in pixels). Example: 44', 'kleo_framework' ),
			'default'     => ''
		),
		array(
			...
			'type'        => 'text',
			'required'    => array( 'resize_logo', 'equals', '1' ),
			'title'       => __( 'Resize Offset', 'kleo_framework' ),
			'subtitle'    => __( 'After how many pixels the header starts to resize.', 'kleo_framework' ),
			'description' => __( '(expressed in pixels). Leave blank to automatically calculate when the header reaches top.', 'kleo_framework' ),
			'default'     => ''
		),
		array(
			...
			'title'       => __( 'Menu Height when scrolled', 'kleo_framework' ),
			'description' => __( 'Applies only to Left and Centered header layout when header is scrolled', 'kleo_framework' ),
			'subtitle'    => __( 'Set your menu height(expressed in pixels). Default is half the Menu height', 'kleo_framework' ),
			'default'     => ''
		),
		/*array(
				'id' => 'sticky_hide_logo',
				...
				'title' => __('Hide logo on scrolled menu', 'kleo_framework'),
				'subtitle' => __('When the page is scrolled the logo will hide and show only the menu(applies to centered layout only)', 'kleo_framework'),
				'default' => '0' // 1 = checked | 0 = unchecked
			),*/
		array(
			'id'          => 'transparent_logo',
			...
			'description' => __( 'DEPRECATED: This will be removed as a general option. Enable it from Page edit only.', 'kleo_framework' ),
			'default'     => '0' // 1 = checked | 0 = unchecked
		),
		...
		array(
			...
			'subtitle' => __( 'If the menu items are too many and would not fit then the extra elements will be added under a new sub-menu.', 'kleo_framework' ),
			'default'  => '0' // 1 = checked | 0 = unchecked
		),
		array(
			'id'       => 'show_lang',
		...
		array(
			...
			'type'     => 'select',
			'title'    => __( 'Search menu location', 'kleo_framework' ),
			'subtitle' => __( 'In which location to show the search item', 'kleo_framework' ),
			'options'  => array(
				'primary'   => __( 'Primary', 'kleo_framework' ),
				'secondary' => __( 'Secondary', 'kleo_framework' ),
...
$sections[] = array(
	'icon'            => 'el-icon-chevron-up',
	'icon_class'      => 'icon-large',
	'title'           => __( 'Top bar', 'kleo_framework' ),
	'desc'            => '',
	'fields'          => array(
		array(
			'id'       => 'show_top_bar',
...
$sections[] = array(
	...
	'icon_class' => 'icon-large',
	'title'      => __( 'Title/Breadcrumb', 'kleo_framework' ),
	'desc'       => __( 'Settings for the title/breadcrumb section that comes just after the menu.<br>To <strong>Style this section</strong> go to Styling options - Title/Breadcrumb', 'kleo_framework' ),
	'fields'     => array(
		array(
		...
		array(
			...
			'options'  => array(
				...
				'right_breadcrumb' => array(
					...
					'img' => KLEO_FW_URI . '/assets/img/right-breadcrumb.png'
				),
				'center'           => array(
					'alt' => 'Centered',
					'img' => KLEO_FW_URI . '/assets/img/center-title.png'
				),
			),
			'default'  => 'normal'
		),
...
$sections[] = array(
	...
	'fields'     => array(
		...
		array(
			...
			'subtitle'    => __( '<strong>It is recommended to enable it for better performance.</strong><br> Enabling it will use default WP engine and will allow plugins like WP Smush to optimize images.', 'kleo_framework' ),
			'description' => __( 'When enabled, you can set different image sizes for each blog listing type.', 'kleo_framework' ),
			'default'     => '0' // 1 = checked | 0 = unchecked
		),
		array(
			'id'       => 'section-title-blog-img',
			'type'     => 'section',
			'title'    => __( 'Image size settings', 'kleo_framework' ),
		...
		array(
			...
			'type'     => 'text',
			'title'    => __( 'Single post & Standard Blog - Image Width', 'kleo_framework' ),
		...
		array(
			...
			'type'     => 'text',
			'title'    => __( 'Single post & Standard Blog -  Image Height', 'kleo_framework' ),
		...
		array(
			...
			'type'     => 'switch',
			'title'    => __( 'Crop instead of resize', 'kleo_framework' ),
			'subtitle' => __( 'Image will be cropped to exact dimension', 'kleo_framework' ),
			'default'  => '0', // 1 = checked | 0 = unchecked
			'required' => array( 'blog_custom_img', 'equals', '1' ),
		),
		array(
			...
			'type'     => 'text',
			'title'    => __( 'Gallery format & Carousel - Image Width', 'kleo_framework' ),
		...
		array(
			...
			'type'     => 'text',
			'title'    => __( 'Gallery format & Carousel - Image Height', 'kleo_framework' ),
...
$sections[] = array(
	...
	'fields'     => array(
		...
		array(
			...
			'type'     => 'switch',
			'title'    => __( 'Enable VK sharing', 'kleo_framework' ),
			'subtitle' => __( 'Show VK sharing icon on mobile and tablet devices', 'kleo_framework' ),
			'default'  => '0' // 1 = checked | 0 = unchecked
		),
		array(
...
$sections[] = array(
	...
	'fields'     => array(
		...
		array(
			'id'       => 'facebook_login',
			'type'     => 'switch',
			'title'    => __( 'Enable Facebook Login', 'kleo_framework' ),
		...
		array(
			...
			'type'     => 'select',
			'title'    => __( 'Redirect after Facebook Registration', 'kleo_framework' ),
			'subtitle' => __( 'Select the redirect action taken when members register with Facebook.', 'kleo_framework' ),
			'options'  => array(
				'default' => __( 'Redirect to profile edit page(BP only)', 'kleo_framework' ),
				'reload'  => __( 'Reload the current page', 'kleo_framework' ),
				'custom'  => __( 'Custom link', 'kleo_framework' ),
			),
			'default'  => 'default',
		...
		array(
			...
			'type'     => 'text',
			'title'    => __( 'Custom URL after registration.', 'kleo_framework' ),
			'subtitle' => __( 'Custom redirect URL after Facebook registration.', 'kleo_framework' ),
			'description' => __( 'You can use ##profile_link## placeholder to redirect to your profile. Example: ##profile_link##/messages', 'kleo_framework' ),
			'default'  => '', // 1 = checked | 0 = unchecked
		...
		array(
			...
			'type'     => 'switch',
			'title'    => __( 'Enable Facebook comments', 'kleo_framework' ),
			'subtitle' => __( 'Use Facebook comments instead of Wordpress default comments', 'kleo_framework' ),
			'default'  => '0' // 1 = checked | 0 = unchecked
		)
	)
);
